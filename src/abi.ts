// https://etherscan.io/address/0xd07dc4262bcdbf85190c01c996b4c06a461d2430#code
// http://api.etherscan.io/api?module=contract&action=getabi&address=0xd07dc4262bcdbf85190c01c996b4c06a461d2430&format=raw
...
export const abi = [
  ...
  { constant: false, inputs: [], name: "renounceSigner", outputs: [], payable: false, stateMutability: "nonpayable", type: "function" },
  {
    constant: false,
    inputs: [
